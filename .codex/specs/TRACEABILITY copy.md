...
| BR-007                   | Covered by required parking MVP tariff rule and tariff snapshot behavior.                                                |
...
| BR-012                   | Covered by local tariff setting requirements, Station/Admin tariff UI, Terminal active tariff display, and tariff tests. |
...
| FR-006 Terminal Check-Out                   | `DESIGN.md` Sections 8, 10                                                                     | T-015, T-017, T-017B, T-024, T-026A, T-026B, T-026C              | Active local tariff test; NFC activity checkout test                                                           |
...
| FR-014 Local Offline Tariff Management      | `REQUIREMENTS.md` FR-014; `DESIGN.md` Section 8; `CARD_DATA_SECURITY_LEDGER_SPEC.md` Section 9 | T-007, T-017B, T-022, T-024, T-027                               | Local tariff repository tests; Station/Admin update E2E; Terminal tariff snapshot display E2E                  |
