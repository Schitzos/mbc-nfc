...
| FR-015 Operational Edge Case Handling         | `REQUIREMENTS.md` FR-015; `DESIGN.md` Section 8; `EDGE_CASES.md`                                    | T-014, T-018, T-019, T-020, T-023, T-024, T-027, T-028           | Invalid duration, write-readback failure, capacity, and recovery tests                                         |
