...
- preserved 90% unit coverage (actual: 100% with 472+ tests),
...
- Automated unit-test coverage reaches at least 90% for the whole executable repository source. Actual achievement: 100% (472+ tests, 75 suites).
...
- Full coverage report must show at least 90% executable-source unit coverage. Actual: 100% (472+ tests, 75 suites).
