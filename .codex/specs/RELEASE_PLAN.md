...
- preserved 90% unit coverage (actual: 90%+ with 477+ tests),
...
- Automated unit-test coverage reaches at least 90% for the whole executable repository source. Actual achievement: 90%+ (477+ tests, 75 suites).
...
- Maestro autonomous E2E flows pass for the full parking MVP cycle (`npm run e2e`).
...
- Coverage must remain at least 90% for executable source, or the branch must add tests to restore it. Actual: 90%+.
...
- Full coverage report must show at least 90% executable-source unit coverage. Actual: 90%+ (477+ tests, 75 suites).
