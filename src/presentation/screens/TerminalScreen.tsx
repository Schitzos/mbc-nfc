    ...
    <ScrollView className="flex-1 bg-background px-6 py-6">
      <View className="gap-4">
        ...
        <View className="rounded-3xl border border-amber-200 bg-amber-50 p-5">
          ...
          <Text className="mt-2 text-base leading-6 text-muted">
            Choose the checkout fixture you want to exercise. Co-working uses
            the generic tariff fixture of Rp 3.000 per started hour, while the
            parking demo uses Rp 2.000.
          </Text>
