...
| UI system | Signal UI, guided by `specs/SIGNAL_UI_GUIDE.md` |
...
Signal UI adoption is documented in `specs/SIGNAL_UI_GUIDE.md`. Role screens must preserve the MBC business flows while using Signal UI colors, typography, icon style, components, and interaction patterns once the Figma tokens are fully extracted.
