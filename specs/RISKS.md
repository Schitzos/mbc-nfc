...
| R-018 | Automated coverage stays below 90% near deadline | Medium | High | Track coverage from the start, prioritize domain/application tests, and fail quality checks when coverage drops below target | Open |
