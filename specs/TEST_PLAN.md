...
Both Senior QA and Test Automation Engineer must maintain detailed E2E case documentation in `specs/E2E_TEST_CASES.md` using a standard test-case format with screenshot evidence references.
...
- E2E cases must be maintained in `specs/E2E_TEST_CASES.md`.
...
- Screenshot evidence is required for executed scenarios and must reference file paths under `specs/test-evidence/`.
