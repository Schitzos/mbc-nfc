...
| Agent operating protocol | Covered by `specs/AGENT_OPERATING_PROTOCOL.md`. |
...
2. Update the relevant design section in `specs/DESIGN.md`.
3. Update implementation tasks in `specs/TASKS.md`.
